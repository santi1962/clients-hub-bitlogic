...
- La cobertura de código no se mide (no hay `c8`/`nyc` configurado). Los tests actuales (198, contando las pruebas de integración MariaDB, el test de guardia de runtime y la de protección de fixtures) apuntan a los hallazgos de seguridad encontrados y a los endpoints más sensibles, no a cobertura exhaustiva de todos los controllers/servicios.
